...
namespace DV\RedactorBundle\DependencyInjection;
...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode = $treeBuilder->root('dv_redactor');
        $rootNode
                ...
                ->children()
                    ->arrayNode('upload_file')
                        ...
                        ->children()
                            ...
                            ->end()
                            ->scalarNode('web_dir')->isRequired()->example("%kernel.root_dir%/../web/uploads/content/images")->end()
