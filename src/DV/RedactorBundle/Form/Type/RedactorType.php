...
namespace DV\RedactorBundle\Form\Type;
...
use DV\RedactorBundle\Model\RedactorService;
...
class RedactorType extends AbstractType
{
    ...
    /**
     * @var \DV\RedactorBundle\Model\RedactorService
     */
    protected $redactorService;

    /**
     * @param \DV\RedactorBundle\Model\RedactorService $redactorService
     */
